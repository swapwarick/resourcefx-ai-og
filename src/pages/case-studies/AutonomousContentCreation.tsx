...
const AutonomousContentCreation = () => {
  return (
    <>
      <Helmet>
        <title>Autonomous Content Creation Agent Case Study | ResourceFX AI</title>
        <meta name="description" content="Learn how ResourceFX AI developed an autonomous content creation agent that increased production by 300% for MediaMax Agency while maintaining quality standards." />
        <meta name="keywords" content="AI content creation, autonomous agents, content automation, MediaMax Agency, AI case study" />
        <link rel="canonical" href="https://resourcefx.ai/case-study/autonomous-content-creation" />
      </Helmet>
      ...
      >
        ...
        <div className="mt-12 p-6 glass-card">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link to="/case-study/knowledge-retrieval-system" className="p-4 bg-primary/5 hover:bg-primary/10 rounded-lg transition-all duration-300">
              <h4 className="text-lg font-medium text-primary mb-2">Knowledge Retrieval System</h4>
              <p className="text-white text-sm">See how our RAG-based knowledge system transformed enterprise information access</p>
            </Link>
            <Link to="/case-study/ai-strategy-implementation" className="p-4 bg-primary/5 hover:bg-primary/10 rounded-lg transition-all duration-300">
              <h4 className="text-lg font-medium text-primary mb-2">AI Strategy Implementation</h4>
              <p className="text-white text-sm">Learn how we developed a comprehensive AI strategy for Manufacturing Innovations Inc</p>
            </Link>
          </div>
        </div>
      </CaseStudyLayout>
