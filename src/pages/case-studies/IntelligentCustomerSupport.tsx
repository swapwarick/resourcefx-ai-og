    ...
    >
      ...
      <div className="my-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-card p-6 flex flex-col items-center text-center">
          ...
          <h3 className="text-lg font-medium mb-2 text-white">10,000+</h3>
          <p className="text-white">Daily customer inquiries</p>
        </div>
        ...
        <div className="glass-card p-6 flex flex-col items-center text-center">
          ...
          <h3 className="text-lg font-medium mb-2 text-white">67%</h3>
      ...
      <div className="my-8 space-y-6">
        <div className="flex">
          ...
          <div>
            <h3 className="text-lg font-medium mb-1 text-white">Initial Assessment & Planning</h3>
        ...
        <div className="flex">
          ...
          <div>
            <h3 className="text-lg font-medium mb-1 text-white">AI Model Development</h3>
            <p className="text-white">
        ...
        <div className="flex">
          ...
          <div>
            <h3 className="text-lg font-medium mb-1 text-white">Intelligent Voice & Chat Agents</h3>
            <p className="text-white">
      ...
      <div className="my-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass-card p-6">
          <h3 className="text-lg font-medium mb-4 text-white">Quantitative Improvements</h3>
          <ul className="space-y-3">
            <li className="flex items-start">
              <span className="text-primary mr-2">→</span>
              <span className="text-white">Reduced average response time from 15 minutes to under 4 minutes (75% improvement)</span>
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-2">→</span>
              <span className="text-white">Increased customer satisfaction from 67% to 94%</span>
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-2">→</span>
              <span className="text-white">Enabled handling of 85% of inquiries without human intervention</span>
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-2">→</span>
              <span className="text-white">Reduced operational costs by 35%</span>
            </li>
          </ul>
        </div>
        ...
        <div className="glass-card p-6">
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              <span className="text-primary mr-2">→</span>
              <span className="text-white">More consistent customer experience across all channels</span>
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-2">→</span>
              <span className="text-white">Higher job satisfaction among human agents who now focus on more complex, rewarding tasks</span>
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-2">→</span>
              <span className="text-white">Enhanced insights into customer needs through AI-powered analytics</span>
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-2">→</span>
              <span className="text-white">Ability to scale support operations during peak seasons without additional hiring</span>
            </li>
          </ul>
        </div>
      </div>
